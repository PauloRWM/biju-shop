const WHATSAPP_URL =
  "https://wa.me/5511945189988?text=" +
  encodeURIComponent("Olá! Vim pelo site da Wesley Bijoux e gostaria de mais informações.");
...
const WhatsAppFloat = () => (
  <a
    ...
    className="fixed bottom-20 md:bottom-5 right-5 z-50 w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#1ebe5a] shadow-xl flex items-center justify-center transition-transform hover:scale-110 active:scale-95"
  >
